...
var Crypto = Crypto || (function () {
    ...
    var C_lib_Base = C_lib.Base = (function () {
        ...
        return {
             ...
             *
             * @param {Crypto.lib.Base} type The potential ancestor.
             *
             * @return {boolean}
             */
            isA: function (type) {
     ...
     * @property {Crypto.enc.*} encoder
     *   The default encoding strategy to convert this word array to a string. Default: Crypto.enc.Hex
     */
    ...
    var C_lib_WordArray = C_lib.WordArray = C_lib_Base.extend({
         ...
         *
         * @param {Crypto.enc.*} encoder (Optional) The encoding strategy to use.
         *
         ...
         *
         * @param {Crypto.lib.WordArray} wordArray The word array to append.
         *
         * @return {Crypto.lib.WordArray} This word array.
         */
         ...
         *
         * @return {Crypto.lib.WordArray} The clone.
         */
        clone: function () {
         ...
         *
         * @return {Crypto.lib.WordArray} The random word array.
         *
         * @static
         */
    ...
    var C_lib_Hash = C_lib.Hash = C_lib_Base.extend({
         ...
         *
         * @param {Crypto.lib.WordArray|string} messageUpdate The message to append.
         *
         * @return {Crypto.lib.Hash} This hash instance.
         */
         ...
         *
         * @param {Crypto.lib.WordArray|string} messageUpdate (Optional) A final message update.
         *
         * @return {Crypto.lib.WordArray} The hash.
         */
         ...
         *
         * @param {Crypto.lib.Hash} hasher The hash algorithm to create a helper for.
         *
         ...
         *
         * @param {Crypto.lib.Hash} hasher The hash algorithm to use with this helper.
         *
         * @return {Function} The shortcut function.
         *
         * @static
    ...
    var C_enc_Hex = C_enc.Hex = {
         ...
         *
         * @param {Crypto.lib.WordArray} wordArray The word array.
         *
         ...
         *
         * @return {Crypto.lib.WordArray} The word array.
         *
         * @static
         */
...
(function () {
    ...
    var C = Crypto;
    var C_lib = C.lib;
    var C_lib_WordArray = C.lib.WordArray;
    var C_lib_Hash = C.lib.Hash;
    var C_algo = C.algo;
